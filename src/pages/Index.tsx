...
import CronogramaSales from "@/components/CronogramaSales";
import DateFilter from "@/components/DateFilter";
import MonthProgress from "@/components/dashboard/MonthProgress";
import { CronogramaDataProcessor } from "@/components/dashboard/CronogramaDataProcessor";
...
function DashboardContent() {
  ...
  const handleCronogramaDataProcessed = (data: any[]) => {
    setCronogramaData(data);
  };

  const refreshCronogramaData = () => {
    // This will trigger the CronogramaDataProcessor to refresh
    setCronogramaData([]);
  };
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 bg-gray-50">
      ...
      <EdgeFunctionProcessor
        ...
        onCronogramaRefresh={refreshCronogramaData}
      />
      <CronogramaDataProcessor 
        loading={loading} 
        onDataProcessed={handleCronogramaDataProcessed}
      />
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center mb-6">
          ...
          />
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 text-center">Desafio do Profissional Parceiro</h1>
